...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'ads_db'),
        'USER': os.environ.get('DB_USER', 'ads_user'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'ads_pass'),
...
if os.environ.get('MINIO_ENDPOINT'):
    STORAGES['default'] = {
        ...
        'OPTIONS': {
            'bucket_name': os.environ.get('MINIO_BUCKET', 'ads-media'),
